...
if (!sendgridApiKey) {
  console.warn('Missing SendGrid API key. Make sure to set SENDGRID_API_KEY in your Vercel project settings or .env.local file.')
}
...
export const sendEmail = async ({ to, subject, html, text }) => {
  try {
    // Get sender email from environment variables with fallback
    const fromEmail = process.env.SENDGRID_FROM_EMAIL || 'chris.t@ventarosales.com'
